          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
              ...
              <div>
                ...
                {formData.category === 'NEW' && (
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, category: e.target.value })}
                    className="w-full mt-2 px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                    required
                  />
                )}
              </div>
            ...
            <div className="mt-6 flex gap-4">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 flex items-center justify-center gap-2 bg-teal-600 text-white px-6 py-2 rounded-md hover:bg-teal-700 disabled:opacity-50"
              >
                <Save size={20} />
